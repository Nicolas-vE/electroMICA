...
Welcome to **electroMICA**! We're happy you want to contribute.
...
We appreciate all contributions to `electroMICA`, but those accepted fastest will
follow a workflow similar to the following:

**1. Comment on an existing issue or open a new issue referencing your addition.**

This allows other members of the **electroMICA** development team to confirm that you
...
**2. Fork the electroMICA repository to your profile.**

This is now your own unique copy of the *electroMICA* repository.
Changes here won't affect anyone else's work, so it's a safe space to explore edits to the code!

Make sure to keep your fork up to date with the original **electroMICA** repository.
